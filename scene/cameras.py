...
class Camera:
    def __init__(self, camera=None, **kwargs):
        ...
        if self.weight is not None and self.height is not None:
            self.data['image_width'] = self.weight
            self.data['image_height'] = self.height
            self.data['original_width'] = self.Weight
            self.data['original_height'] = self.Height
        else:
