...
class ZJUMoCapDatasetforview(Dataset):
    def __init__(self, cfg, split='train'):
        ...
        if cfg.freeview:
            ...
            cam_names = self.cameras['all_cam_names']
        # hardcoded
        train_betas = [[-0.7631000280380249, -0.12389999628067017, 0.04749999940395355, -0.2054000049829483, -0.15369999408721924, -0.13050000369548798,
                         -0.007300000172108412, 0.0860000029206276, -0.14980000257492065, 0.14499999582767487]]
